...
class Database():
    ...
    def writeAthonetSlices(self, data: Union[AthonetSlice, List[AthonetSlice]]):
        ...
        try:
            ...
            for elem in dataList:
                ...
                self.__write(athonetSlicesCollectionName, elem)
    ...
    def readAthonetSlices(self, sliceId: dict = None) -> AthonetSlice | [AthonetSlice]:
        try:
            self.__read(athonetSlicesCollectionName, ({"sliceId": sliceId} if not sliceId else None))
        except Exception as e:
